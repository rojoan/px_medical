 ...
 * 2017-10-26
 */
@QueryInfo(from = "com.bofan.publichealth.valueobject.ExamInHospital ih", orderBy = "ih.inHospitalId asc")
public class ExamInHospitalQueryInfo extends BaseCommandInfo {
    ...
    @QueryParam(fieldName = "ih.examPersonId", op = QueryOperator.EQU)
    private Long examPersonId;

    @QueryParam(fieldName = "ih.personDetailId", op = QueryOperator.EQU)
