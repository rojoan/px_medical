 ...
 * 2017-10-26
 */
@QueryInfo(select = "es.symptomId", from = "com.bofan.publichealth.valueobject.ExamSymptom es", orderBy = "es.symptomId asc")
public class ExamSymptomIdQueryInfo extends BaseCommandInfo {
