 ...
 * 2017-10-26
 */
@QueryInfo(select = "hea.eduArchiveType", from = "com.bofan.publichealth.valueobject.HealthEduArchive hea", orderBy = "hea.healthEducationId asc")
public class HealthEduArchiveIdQueryInfo extends BaseCommandInfo {
