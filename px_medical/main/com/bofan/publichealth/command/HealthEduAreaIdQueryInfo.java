 ...
 * 2017-10-26
 */
@QueryInfo(select = "hha.putArea", from = "com.bofan.publichealth.valueobject.HealthEduArea hha", orderBy = "hha.eduAreaId asc")
public class HealthEduAreaIdQueryInfo extends BaseCommandInfo {
