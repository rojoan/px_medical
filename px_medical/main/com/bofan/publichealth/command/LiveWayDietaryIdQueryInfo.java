 ...
 * 2017-10-26
 */
@QueryInfo(select="lwd.dietaryHabitId", from = "com.bofan.publichealth.valueobject.LiveWayDietary lwd", orderBy = "lwd.liveWayDietaryId asc")
public class LiveWayDietaryIdQueryInfo extends BaseCommandInfo {
