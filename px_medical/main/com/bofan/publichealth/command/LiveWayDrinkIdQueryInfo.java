 ...
 * 2017-10-26
 */
@QueryInfo(select="lwd.drinkTypeId", from = "com.bofan.publichealth.valueobject.LiveWayDrink lwd", orderBy = "lwd.liveWayDrinkId asc")
public class LiveWayDrinkIdQueryInfo extends BaseCommandInfo {
