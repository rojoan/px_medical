 ...
 * 2017-10-26
 */
@QueryInfo(select = "pcd.dangerType", from = "com.bofan.publichealth.valueobject.PersonChronicDanger pcd", orderBy = "pcd.chronicDangerId asc")
public class PersonChronicDangerIdQueryInfo extends BaseCommandInfo {
