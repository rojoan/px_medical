 ...
 * 2017-10-26
 */
@QueryInfo(select = "pcdb.diagnoseBasis", from = "com.bofan.publichealth.valueobject.PersonChronicDiagBasis pcdb", orderBy = "pcdb.chronicDiagBasisId asc")
public class PersonChronicDiagBasisIdQueryInfo extends BaseCommandInfo {
