 ...
 * 2017-10-26
 */
@QueryInfo(select = "pcd.diagnoseType", from = "com.bofan.publichealth.valueobject.PersonChronicDiagnose pcd", orderBy = "pcd.chronicDiagnoseId asc")
public class PersonChronicDiagnoseIdQueryInfo extends BaseCommandInfo {
