 ...
 * 2017-10-26
 */
@QueryInfo(select = "pcn.nonDrugType", from = "com.bofan.publichealth.valueobject.PersonChronicNonDrug pcn", orderBy = "pcn.chronicNonDrugId asc")
public class PersonChronicNonDrugIdQueryInfo extends BaseCommandInfo {
    ...
    @QueryParam(fieldName = "pcn.personChronicId", op = QueryOperator.EQU)
    private Long personChronicId;

    @QueryParam(fieldName = "pcn.personDetailId", op = QueryOperator.EQU)
    private Long personDetailId;
    
    @QueryParam(fieldName = "pcn.chronicType", op = QueryOperator.EQU)
