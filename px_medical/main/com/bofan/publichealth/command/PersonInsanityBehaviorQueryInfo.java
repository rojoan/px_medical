 ...
 * 2017-10-26
 */
@QueryInfo(from = "com.bofan.publichealth.valueobject.PersonInsanityBehavior pib", orderBy = "pib.personInsanityBehaviorId asc")
public class PersonInsanityBehaviorQueryInfo extends BaseCommandInfo {
    ...
    @QueryParam(fieldName = "pib.personInsanityId", op = QueryOperator.EQU)
    private Long personInsanityId;
    
    @QueryParam(fieldName = "pib.personInsanityVisitId", op = QueryOperator.EQU)
    private Long personInsanityVisitId;

    @QueryParam(fieldName = "pib.recordFlag", op = QueryOperator.EQU)
