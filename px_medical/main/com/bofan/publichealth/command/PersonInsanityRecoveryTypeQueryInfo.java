 ...
 * 2017-10-26
 */
@QueryInfo(select = "pir.recoveryType", from = "com.bofan.publichealth.valueobject.PersonInsanityRecovery pir", orderBy = "pir.personInsanityRecoveryId asc")
public class PersonInsanityRecoveryTypeQueryInfo extends BaseCommandInfo {
