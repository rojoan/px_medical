 ...
 * 2017-10-26
 */
@QueryInfo(select = "pis.symptomId", from = "com.bofan.publichealth.valueobject.PersonInsanitySym pis", orderBy = "pis.personInsanitySymId asc")
public class PersonInsanitySymIdQueryInfo extends BaseCommandInfo {
