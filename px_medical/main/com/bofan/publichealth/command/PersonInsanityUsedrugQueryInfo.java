 ...
 * 2017-10-26
 */
@QueryInfo(from = "com.bofan.publichealth.valueobject.PersonInsanityUsedrug piu", orderBy = "piu.personInsanityUsedrugId asc")
public class PersonInsanityUsedrugQueryInfo extends BaseCommandInfo {
    ...
    @QueryParam(fieldName = "piu.personInsanityId", op = QueryOperator.EQU)
    private Long personInsanityId;

    @QueryParam(fieldName = "piu.personDetailId", op = QueryOperator.EQU)
    private Long personDetailId;
    
    @QueryParam(fieldName = "piu.personInsanityVisitId", op = QueryOperator.EQU)
