 ...
 * 2017-10-26
 */
@QueryInfo(select = "pvc.contentType", from = "com.bofan.publichealth.valueobject.PersonVisitContent pvc", orderBy = "pvc.visitContentId asc")
public class PersonVisitContentIdQueryInfo extends BaseCommandInfo {
