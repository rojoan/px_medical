 ...
 * 2017-10-26
 */
@QueryInfo(select = "pvc.cureType", from = "com.bofan.publichealth.valueobject.PersonVisitCure pvc", orderBy = "pvc.visitCureId asc")
public class PersonVisitCureIdQueryInfo extends BaseCommandInfo {
