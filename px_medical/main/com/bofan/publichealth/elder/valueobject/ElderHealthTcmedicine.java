 ...
 */
@Entity
@Table(name = "ELDER_HEALTH_TCMEDICINE", schema = SchemaConsts.PUBLIC_HEALTH)
@SequenceGenerator(name = "ELDER_HEALTH_TCMEDICINE_ID", sequenceName = SchemaConsts.PUBLIC_HEALTH + ".ELDER_HEALTH_TCMEDICINE_ID", allocationSize = 1)
public class ElderHealthTcmedicine {

    /** 老年人中医药评估ID */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ELDER_HEALTH_TCMEDICINE_ID")
    @Column(name = "ELDER_HEALTH_TCMEDICINE_ID", unique = true, nullable = false, precision = 18, scale = 0)
    ...
    /** 评估得分 */
    @Column(name = "TCM_ASSESS_SCORE", precision = 18, scale = 0)
    ...
    @Column(name = "TCM_ASSESS_RESULT", length = 1)
