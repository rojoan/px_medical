 ...
 */
@Entity
@Table(name="PERSON_INSANITY_RECOVERY", schema = SchemaConsts.PUBLIC_HEALTH)
@SequenceGenerator(name = "PERSON_INSANITY_RECOVERY_ID", sequenceName = SchemaConsts.PUBLIC_HEALTH + ".PERSON_INSANITY_RECOVERY_ID", allocationSize = 1)
public class PersonInsanityRecovery implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PERSON_INSANITY_RECOVERY_ID")
	@Column(name="PERSON_INSANITY_RECOVERY_ID", unique=true, nullable=false, precision=18)
	private Long personInsanityRecoveryId;
	...
	@Column(name="RECOVERY_TYPE", nullable=false, length=2)
	private String recoveryType;
	
	@Column(name="RECORD_FLAG", nullable=false, length=1)
    private String recordFlag;

	public PersonInsanityRecovery() {
	    
	}

    /**
     * @return the personInsanityRecoveryId
     */
    public Long getPersonInsanityRecoveryId() {
        return personInsanityRecoveryId;
    }

    /**
     * @param personInsanityRecoveryId the personInsanityRecoveryId to set
     */
    public void setPersonInsanityRecoveryId(Long personInsanityRecoveryId) {
        this.personInsanityRecoveryId = personInsanityRecoveryId;
    }
