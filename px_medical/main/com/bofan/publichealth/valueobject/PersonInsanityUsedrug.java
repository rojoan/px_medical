 ...
 */
@Entity
@Table(name="PERSON_INSANITY_USEDRUG", schema = SchemaConsts.PUBLIC_HEALTH)
@SequenceGenerator(name = "PERSON_INSANITY_USEDRUG_ID", sequenceName = SchemaConsts.PUBLIC_HEALTH + ".PERSON_INSANITY_USEDRUG_ID", allocationSize = 1)
public class PersonInsanityUsedrug implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PERSON_INSANITY_USEDRUG_ID")
	@Column(name="PERSON_INSANITY_USEDRUG_ID", unique=true, nullable=false, precision=18)
	private Long personInsanityUsedrugId;
	...
	public PersonInsanityUsedrug() {
	}

    /**
     * @return the personInsanityUsedrugId
     */
    public Long getPersonInsanityUsedrugId() {
        return personInsanityUsedrugId;
    }

    /**
     * @param personInsanityUsedrugId the personInsanityUsedrugId to set
     */
    public void setPersonInsanityUsedrugId(Long personInsanityUsedrugId) {
        this.personInsanityUsedrugId = personInsanityUsedrugId;
    }
