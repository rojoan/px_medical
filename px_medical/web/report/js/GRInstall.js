...
function Install_Detect()
{
    ...
    {
        document.write('<div style="position: absolute; z-index: 99999; min-height:150px; width:70%; left:15%; bottom: 15%; min-height:150px; border-radius: 7px; color: #fff; background: rgba(11,74,183,0.8); text-align: center; vertical-align: middle; line-height: 30pt; padding: 12px 0;">');
        document.write('<strong style="font-size:20px;">此页面需要安装 锐浪报表插件 才能保证其正常运行</strong><br />');
            
        if( _gr_isIE )
            document.write('<strong>如浏览器的顶部或底部出现提示条，左键点击提示条并运行加载项，按此方式安装最简便</strong><br />');
            
        document.write('<a href="' + gr_InstallPath + '/grbsctl6.exe" style="color: #04e534; font-size:16px;"><strong>【点击此处下载锐浪报表插件安装包】<br /></strong></a>');
        document.write('锐浪报表插件安装后，<a href="#" style="color: #12e225;" onclick="javascript:document.location.reload();">【点击此处】</a> 重新加载此页面。如果这些提示文字还出现，可能是当前浏览器不支持插件，<a style="color: #f58611;" href="http://www.rubylong.cn/grplugin_browsersupport.htm">【点击了解更多说明】</a>。');
        document.write('</div>');
        return false;
    }
