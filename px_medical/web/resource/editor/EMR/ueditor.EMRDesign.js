...
(function (win, UE) {
    ...
    UE.plugins["tl_select"] = function () {
        var me = this, thePlugins = 'tl_select', dialog = getDialog(me, thePlugins, "select.html?temp=" + new Date().getTime(), "下拉单选输入框", 'width:600px;height:550px;', [
            {
                className: 'edui-okbutton',
                label: '确定',
                onclick: function () {
    ...
    UE.registerUI('tl_select', function (editor, uiName) {
        var dialog = getDialog(editor, uiName, "select.html?temp=" + new Date().getTime(), "下拉单选输入框", 'width:600px;height:550px;', [
            {
                className: 'edui-okbutton',
                label: '确定',
                onclick: function () {
